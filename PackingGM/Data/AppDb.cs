...
namespace PackingGM.Data
{
    ...
    {
        public AppDb() : base("name=DefaultConnection2")
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //Удалил чертежи теперь Д3 связывается с типом агрегата
            ...
            //Теперь одно ГМ упаковывает 1 цех
        ...
        public DbSet<GMTare> GMTares { get; set; }
